"""Welcome to the Minesweeper game! This documentation provides
   an overall overview of the key components and functionalities of
   the Minesweeper project implemented in Python using the Pygame library.
"""
...
class Game:
	"""Create a Game class to manage game settings, difficulty levels,
	...
	def set_difficulty(self, difficulty):
		"""This method helps the user to choose the difficulty based on a pre-defined set of difficulties.
		   These contain beginner, intermediate, and expert level. 
		   Note that, the number of rows and columns on each level differs.
		"""
		if difficulty == 'beginner':
			...
			self.size = {'rows': 17, 'cols': 30}
			self.num_mines = 99

	def setup_window(self):
		"""Set up the game window with dimensions based on
		   the number of rows, columns, and top panel height.
		"""
	...
	def new_game(self, difficulty):
		"""The new_game method resets the game state,
		   sets the difficulty, and initialize a new window.
		"""
		self.gameover = False
	...
	def display_new_game_menu(self):
		"""This method is to display the new-game menu.
		"""
	...
	def display_gameover_menu(self, heading):
		"""This method is to display the gameover menu if the user clicks on the mine.
		"""
		my_theme = pygame_menu.themes.THEME_BLUE
		my_theme.title_font_size = 18
		my_theme.widget_font_size = 12
	...
	def create_cells(self):
		"""This method creates the cells given the number of rows and columns.
		"""
	...
	def draw_top_panel(self):
		"""This methods creates the top panel where the number of flags used and timer are shown.
		"""
	...
	def get_clicked_cell(self, click_location):
		"""This method is used to identify whether the cell was clicked or not
		   which helps to reveal that cell 
		"""
	...
	def left_click(self, click_location):
		"""This methond helps handling left mouse click to reveal relevant cell/cells. 
		"""
	...
	def right_click(self, click_location):
		"""This method helps handling right mouse click to place a flag on a relevant cell.
		"""
		# do nothing if the game is over
		if self.gameover:
			return
	...
	def place_mines(self, clicked_cell):
		"""Place mines randomly, ensuring a safe distance
		   from the first clicked cell.
		"""
	...
	def update_clues(self):
		"""Calculate and update clues based on the number of
		   surrounding mines.
		"""
		# iterate through every cell
		for (row, col) in self.cells:
...
class Cell(pygame.Rect):
	"""The Cell class is responsible for individual cells in the game grid.
	"""
	...
	def draw(self, window):
		"""Implement a method to draw cells with alternating background
		   colors, display mines, flags and clues.
		"""
	...
	def reveal(self, cells):
		"""Implement a method to recursively reveal surrounding cells
...
def main():
	"""Define the main function to start the game, initialize
	   the game loop, and handle related events. Display relevant menus and
	   reveal all cells if the game ends, whether cleared or failed.
	"""
	# create the game
	game = Game()
